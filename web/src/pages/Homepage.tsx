...
export function Homepage() {
  return (<>
    ...
    <div className="bg-dark-blue pb-10 pt-4">
      <p className="text-center text-[44px] font-bold text-white">Top rated recipes</p>
    ...
    <form className="grid grid-cols-5 gap-x-28 px-[15vw] py-8">
      <h1 className="text-green col-span-5 mb-10 text-[44px] font-bold">Contact us</h1>
      ...
      <button
        className="bg-green col-start-5 mt-4 rounded-[15px] py-2 text-[20px] font-semibold text-white"
      >Submit</button
      >
    </form>
